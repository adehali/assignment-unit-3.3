...
let secondItem = 5; 
console.log("Second value is: ", secondItem);
...
console.log('Removed last array', [removedItem]);
console.log('The arrays are now', supplyChanges);


// 5. A delivery of 25 more parts arrived. Add the value 25 to the end of the array
console.log('5. Add the value 25 into supplyChanges.');
supplyChanges.push(25);
console.log('Added value 25', supplyChanges);
...
console.log('Zeroe Numbers', zeroes);
...
console.log('Sum of TotalParts & supplyChanges:' , totalParts); 
